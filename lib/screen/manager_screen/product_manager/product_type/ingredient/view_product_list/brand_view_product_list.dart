...
class _type_view_product_listState extends State<type_view_product_list> {
  List<String> productId = [];

  void get_product_list() {
    if (widget.id != '') {
      final reference = FirebaseDatabase.instance.ref();
      reference.child("productType").child(widget.id).child('productList').onValue.listen((event) {
